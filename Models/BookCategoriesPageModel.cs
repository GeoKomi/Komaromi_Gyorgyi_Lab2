...
namespace Komaromi_Gyorgyi_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Komaromi_Gyorgyi_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Komaromi_Gyorgyi_Lab2Context context,
